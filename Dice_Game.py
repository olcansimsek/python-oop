...
class DiceGame:
    ...
    def show_dice(self, player_value, computer_value):
        ...
        print("Computer die: {0}\n".format(computer_value))

    def show_counters(self):
        print("\nYour counter: {0}".format(self.player.counter))
        print("Computer counter: {0}".format(self.computer.counter))
        print ("-----------------------------")
    ...
    def check_game_over(self):
        if self.player.counter == 0:
            self.show_game_over(winner="YOU")
            return True
        elif self.computer.counter == 0:
            self.show_game_over(winner="THE COMPUTER")
            return True
        else:
            return False
    ...
    def show_game_over(self, winner):
        ...
        print("=====================================")
        print(" {0} won the game.".format(winner))
        print("=====================================")
        if winner == "YOU":
